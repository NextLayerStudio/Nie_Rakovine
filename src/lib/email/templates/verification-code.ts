    ...
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin:0 0 20px;">
      <tr>
        <td class="ok-surface" style="padding:22px 24px;text-align:center;background:#FFF3F9;border-radius:18px;border:1px solid rgba(111,35,128,0.12);">
          <div class="ok-text" style="font-size:34px;font-weight:800;letter-spacing:0.35em;color:#6F2380;padding-left:0.35em;">${escapeHtml(spaced)}</div>
        </td>
      </tr>
    </table>
    <p class="ok-muted" style="margin:0;font-size:13px;line-height:1.6;color:#6F2380B3;">Kód je platný ${input.ttlMinutes} minút. Ak ste o registráciu nežiadali, tento e-mail pokojne ignorujte.</p>`;
