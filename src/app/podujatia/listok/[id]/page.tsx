    ...
    <main className="min-h-screen bg-[#FFF3F9] font-sans">
      ...
      <section className="pt-28 pb-20">
        <div className="mx-auto max-w-md px-5">
          {ticket ? (
            <TicketDetails ticket={ticket} appUrl={appUrl} />
          ) : (
            <div className="rounded-2xl bg-white p-6 text-center shadow-sm ring-1 ring-[#6F2380]/10">
              <h2 className="text-lg font-black text-[#6F2380]">Lístok nenájdený</h2>
              <p className="mt-2 text-sm text-[#6F2380]/70">
                Tento lístok neexistuje, alebo bola registrácia na podujatie zrušená.
              </p>
            </div>
          )}
        </div>
